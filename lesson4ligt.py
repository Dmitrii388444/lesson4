...
print(f'частые имена в полученном списке',how_often(rand_name_list)[0])
print(f'редкие буквы с которых начинаются имена в полученном списке',rare_letter(rand_name_list))